...
<meta name="description" content="Earn Money by Completing Surveys, Offers,Playing Games And Get Paid Today With Freeloot"/>
...
<title>
    ...
    <?php else: ?>
         <?php if(Auth::check()): ?>
            ...
            Turn Your Time Into Money and Get Paid Today | freeloot
            <?php else: ?>
            <?php echo e(ucwords(request()->segment(count(request()->segments())))); ?> | freeloot
            <?php endif; ?>
        <?php else: ?>
            Freeloot | Turn Your Time Into Money and Get Paid Today
        <?php endif; ?>
    <?php endif; ?>
</title>
...
<?php /**PATH /home/freebpbk/demo.freeloot.net/core/resources/views/layouts/frontend/partial/head.blade.php ENDPATH**/ ?>