...
<?php endif; ?>
                            <br>
                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'bs::components.input','data' => ['type' => 'text','model' => 'name.proxycheck_io_api','label' => __('Your Proxycheck.io Api Key')]]); ?>
<?php $component->withName('bs::input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => 'text','model' => 'name.proxycheck_io_api','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Your Proxycheck.io Api Key'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                ...
                <button type="submit" class="btn btn-success btn-block w-100" style="box-shadow:none;background: #6FB99F;border-color:#6FB99F;border-radius:10px;" ><?php echo app('translator')->get('Save'); ?></button>
            </form>
        </div>
    </div>
</div>
<?php /**PATH /home/u972333121/domains/testnetgainify.net/public_html/core/resources/views/system/admin/setup.blade.php ENDPATH**/ ?>