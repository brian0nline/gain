<?php $__env->startSection('panel'); ?>
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body ">
                    <a href="<?php echo e(route('moder.ticket.index')); ?>" class="btn btn-sm btn-primary my-1 text-small"><i
                            class="fa fa-fw fa-backward"></i> <?php echo app('translator')->get('Go Back'); ?> </a>
                    <h6 class="card-header  my-2">
                        <div class="row">
                            <div class="col-sm-8 col-md-6">
                                <?php if($ticket->status == 0): ?>
                                    <span class="badge bg-success py-1 px-2"><?php echo app('translator')->get('Open'); ?></span>
                                <?php elseif($ticket->status == 1): ?>
                                    <span class="badge bg-primary py-1 px-2"><?php echo app('translator')->get('Answered'); ?></span>
                                <?php elseif($ticket->status == 2): ?>
                                    <span class="badge bg-warning py-1 px-2"><?php echo app('translator')->get('Customer Reply'); ?></span>
                                <?php elseif($ticket->status == 3): ?>
                                    <span class="badge bg-dark py-1 px-2"><?php echo app('translator')->get('Closed'); ?></span>
                                <?php endif; ?>
                    ...
                    <?php if($ticket->status != 3): ?>
                    <form action="<?php echo e(route('moder.ticket.reply', $ticket->id)); ?>" enctype="multipart/form-data"
                        ...
                        <div class="row ">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <textarea class="form-control my-1" name="message" rows="3" id="inputMessage"
                                        placeholder="<?php echo app('translator')->get('Your Message'); ?>" style="height: 100px"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row form-group">
                                    <div class="col-9 ">
                                        <div class="custom-file" data-text="<?php echo app('translator')->get('Select your file!'); ?>">
                                            <input type="file" name="attachments[]" id="inputAttachments"
                                                class="form-control" />
                                            <label for="inputAttachments"
                                                class="custom-file-label"><?php echo app('translator')->get('Attachments'); ?></label>
                                        </div>
                            ...
                            <div class="col-md-3 offset-md-3">
                                <button class="btn btn-primary btn-block mt-4" type="submit" name="replayTicket"
                                    value="1"><i class="fas fa-fw la-lg fa-reply"></i> <?php echo app('translator')->get('Reply'); ?>
                                </button>
                            </div>
                        </div>
                    </form>
                    <?php else: ?>
                    <h3><?php echo app('translator')->get('This is closed ticket'); ?> 
                         </h3>
                    <?php endif; ?>
                    ...
                    <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($message->admin_id == 0): ?>
                            <div class="row border border-primary border-radius-3 my-3 mx-2">
                                ...
                                <div class="col-md-3 border-right text-right">
                                    ...
                                    <button data-id="<?php echo e($message->id); ?>" type="button" data-toggle="modal"
                                        data-target="#DelMessage" class="btn btn-danger btn-sm my-3 delete-message">
                                        <i class="fa fa-trash"></i> <?php echo app('translator')->get('Delete'); ?></button>
                                </div>
                                    ...
                                    <?php if($message->attachments()->count() > 0): ?>
                                        <div class="my-3">
                                            <?php $__currentLoopData = $message->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="<?php echo e(route('moder.ticket.download', encrypt($image->id))); ?>"
                        ...
                        <?php else: ?>
                            <div class="row border border-warning border-radius-3 my-3 mx-2 admin-bg-reply">
                                ...
                                <div class="col-md-9">
                                    <p class="text-muted font-weight-bold my-3">
                                        <?php echo app('translator')->get('Posted on'); ?> <?php echo e(showDateTime($message->created_at, 'l, dS F Y @ H:i')); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="<?php echo e(route('moder.ticket.reply', $ticket->id)); ?>">
                        <?php echo csrf_field(); ?>

                        <button type="button" class="btn btn-dark" data-dismiss="modal"><?php echo app('translator')->get('Close'); ?> </button>
                        <button type="submit" class="btn btn-success" name="replayTicket" value="2"> <?php echo app('translator')->get('Close Ticket'); ?>
                        </button>
                    </form>
                </div>
            </div>
    ...
    <div class="modal fade" id="DelMessage" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form method="post" action="<?php echo e(route('moder.ticket.delete')); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <button type="submit" class="btn btn-danger"><i class="fa fa-trash"></i> <?php echo app('translator')->get('Delete'); ?>
                        </button>
                    </form>
                </div>
        ...
        (function($) {
            ...
            $('.extraTicketAttachment').on('click', function() {
                $("#fileUploadsContainer").append(
                    `
                <div class="file-upload-wrapper" data-text="<?php echo app('translator')->get('Select your file!'); ?>"><input type="file" name="attachments[]" id="inputAttachments" class="form-control"/></div>`
                )
            });
        })(jQuery);
    </script>
...
<?php echo $__env->make('admin.layout.primary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/freebpbk/public_html/core/resources/views/admin/support/reply.blade.php ENDPATH**/ ?>