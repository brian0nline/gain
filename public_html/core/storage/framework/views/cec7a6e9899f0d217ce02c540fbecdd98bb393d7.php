...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'bs::components.button','data' => ['type' => 'submit','class' => 'my-2 custom-profile-setting-btn','label' => __('Update'),'icon' => 'share','style' => 'box-shadow: none;font-size:14px;','disabled' => true]]); ?>
<?php $component->withName('bs::button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => 'submit','class' => 'my-2 custom-profile-setting-btn','label' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Update')),'icon' => 'share','style' => 'box-shadow: none;font-size:14px;','disabled' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
                ...
                <form action="<?php echo e(route('user.account.delete')); ?>" method="post">
                   <?php echo csrf_field(); ?>
                    ...
                    <div class="modal-footer  justify-content-center border-0">
                        ...
                        <button type="submit" class="btn btn-primary" style="font-size:14px;background:#e84b3c;border-color:#e84b3c;box-shadow:none;" disabled><?php echo app('translator')->get('Delete'); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/freebpbk/demo.freeloot.net/core/resources/views/user/profile/setting.blade.php ENDPATH**/ ?>