<?php $__env->startSection('title', trans('Login | Gainify')); ?>
...
<form class="account-form" method="POST" action="<?php echo e(route('user.login')); ?>" onsubmit="return submitUserForm();">
    ...
    <div class="form-group text-end">
        <a href="<?php echo e(route('user.password.request')); ?>" class="text-drak" style="text-decoration:none;color: #6FB99F"><?php echo app('translator')->get('Forgot Password?'); ?></a>
    </div>
    ...
    <p class="text-center mt-3"><span class=""><?php echo app('translator')->get('New to'); ?> Gainify?</span>
        <a href="<?php echo e(route('user.register')); ?>" class="text-base"style="text-decoration:none;color: #6FB99F"><?php echo app('translator')->get('Register here'); ?></a>
    </p>
</form>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u972333121/domains/testnetgainify.net/public_html/core/resources/views/user/auth/login.blade.php ENDPATH**/ ?>