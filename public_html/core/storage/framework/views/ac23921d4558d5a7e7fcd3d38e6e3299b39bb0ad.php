            ...
            <div class="modal-content bg--dark">
                ...
                <form action="<?php echo e(route('user.twofactor.enable')); ?>" method="POST">
                    ...
                    <div class="modal-footer"  style="border-top: 1px solid #242B27;">
                        ...
                        <button type="submit" class="btn btn-primary" style="background:#4aa276;border-color:#4aa276;box-shadow:none;"><?php echo app('translator')->get('Verify'); ?></button>
                    </div>
                </form>
            </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content bg--dark">
                ...
                <form action="<?php echo e(route('user.twofactor.disable')); ?>" method="POST">
                    ...
                    <div class="modal-footer"  style="border-top: 1px solid #242B27;">
                        <button type="button" class="btn btn--secondary" data-bs-dismiss="modal" style="background:#3B4740;border-color:#3B4740;box-shadow:none;color:#fff;"><?php echo app('translator')->get('Close'); ?></button>
                        <button type="submit" class="btn btn-primary" style="background:#4aa276;border-color:#4aa276;box-shadow:none;"><?php echo app('translator')->get('Disable'); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/freebpbk/public_html/core/resources/views/user/twofactor.blade.php ENDPATH**/ ?>