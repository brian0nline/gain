    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="<?php echo e(route('moder.offer.create')); ?>" class="btn btn-sm btn-dark float-end"style="box-shadow:none;background:#4aa276;border-color:#4aa276;border-radius:10px;" >
                <i class="fas fa-plus" style="box-shadow:none;background:#3b4740;border-color:#3b4740;"></i> <?php echo app('translator')->get('New offerwall'); ?>
            </a>
        </div>
        <div class="card-body">
                            ...
                            <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                ...
                                <form action="<?php echo e(route('moder.offer.delete', $offer->id)); ?>" method="post">
                                    ...
                                    <button type="submit" class="btn btn-sm btn-info  m-1" data-toggle="tooltip"
                                        title="" data-original-title="<?php echo app('translator')->get('Delete'); ?>" style="background:#e84b3c;border-color:#e84b3c;box-shadow:none;" />
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layout.primary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/freebpbk/public_html/core/resources/views/system/admin/offer-wall/list.blade.php ENDPATH**/ ?>