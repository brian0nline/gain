            ...
            <div class="modal-content bg-dark" style="border-radius: 20px;">
                <form action="<?php echo e(route('user.withdraw.money')); ?>" method="post">
                    ...
                    <div class="modal-footer  justify-content-center border-0">
                        <button type="submit" class="btn btn-primary" style="box-shadow: none;font-size:14px;" disabled><?php echo app('translator')->get('Confirm'); ?></button>
...
<?php echo $__env->make('layouts.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/freebpbk/demo.freeloot.net/core/resources/views/user/withdraw/methods.blade.php ENDPATH**/ ?>