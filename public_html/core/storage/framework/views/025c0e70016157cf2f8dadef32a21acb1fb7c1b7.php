...
<footer class="footer pb-5" style="user-select:none;display:grid;">
    <div class="container">
        <div class="row">
            ...
            <img src="<?php echo e(asset('asset/img/freelootlogo.svg')); ?>" style="margin-top:20px;pointer-events: none">
            <a href="https://play.google.com/store/apps/details?id=net.freeloot.twa" target="_blank">
            <img src="<?php echo e(asset('asset/img/getitonplaystore.svg')); ?>" style="margin-top:10px;pointer-events: none">
            </a>
            </div>
            <div class="col-xl-3 col-md-4 col-sm-6">
                <div class="widget">
                <h4 style="margin-top: 30px;letter-spacing:3px;opacity: .8;" class="hdue">About US:</h4>
                    <div class="links-group">
                    <a href="<?php echo e(route('faq')); ?>" class="footer-link mt-2"style="letter-spacing:3px;opacity: .8;text-decoration:none;" class="paraff">
                          <i><img src="<?php echo e(asset('asset/img/faq.svg')); ?>" style="pointer-events: none" ></i></i>
                          Faq
                    </a>
                        <a href="<?php echo e(route('tos')); ?>" class="footer-link mt-2"style="letter-spacing:3px;opacity: .8;text-decoration:none;" class="paraff">
                              <i><img src="<?php echo e(asset('asset/img/tos.svg')); ?>" style="pointer-events: none" ></i></i>
                              Terms of Service
                        </a>
                        <a href="<?php echo e(route('policy')); ?>" class="footer-link mt-2"style="letter-spacing:3px;opacity: .8;text-decoration:none;" class="paraff">
                              <i><img src="<?php echo e(asset('asset/img/policy.svg')); ?>" style="pointer-events: none" ></i></i>
                              Privacy Policy
                        </a>
                       <!-- <a href="mailto:support@freeloot.net" class="footer-link mt-2"style="letter-spacing:3px;opacity: .8;font-size:13px;text-decoration:none;">
                              <i><img src="<?php echo e(asset('asset/img/build.svg')); ?>" style="pointer-events: none"></i></i>
                              Want to build your GPT Site?
                        </a>-->
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-4 col-sm-6">
                ...
                <h4 style="margin-top:30px;letter-spacing:3px;opacity: .8;" class="hdue">Quick Links:</h4>
                    <div class="links-group">
                        <a href="<?php echo e(route('user.register')); ?>" class="footer-link mt-2"style="letter-spacing:3px;opacity: .8;text-decoration:none;" >
                        <i><img src="<?php echo e(asset('asset/img/signup.svg')); ?>" style="pointer-events: none" ></i></i>
                        Register
                        </a>
                        <a href="<?php echo e(route('user.login')); ?>" class="footer-link mt-2"style="letter-spacing:3px;opacity: .8;text-decoration:none;">
                            <i><img src="<?php echo e(asset('asset/img/login.svg')); ?>" style="pointer-events: none"></i></i>
                            Login
                        </a>
            ...
            <div class="col-xl-3 col-md-4 col-sm-6">
                <div class="widget">
                <h4 style="margin-top: 30px;letter-spacing:3px;opacity: .8;" class="hdue">Social:</h4>
                    <div class="links-group">
                      <!--  <a href="https://instagram.com/freelootnet" target="_blank" class="footer-link mt-2" style="letter-spacing:3px;opacity: .8;text-decoration:none;">
                             <i><img src="<?php echo e(asset('asset/img/ig.svg')); ?>" style="pointer-events: none"></i></i>
                            Instagram
                        </a>-->
                    <a href="https://www.trustpilot.com/review/freeloot.net" target="_blank" class="footer-link mt-2" style="letter-spacing:3px;opacity: .8;text-decoration:none;">
                          <i><img src="<?php echo e(asset('asset/img/trust.svg')); ?>" style="pointer-events: none" ></i></i>
                            Trustpilot
                        </a>
                       <!-- <a href="https://t.me/officialfreeloot" target="_blank" class="footer-link mt-2" style="letter-spacing:3px;opacity: .8;text-decoration:none;">
                          <i><img src="<?php echo e(asset('asset/img/telegram.svg')); ?>" style="pointer-events: none"></i></i>
                            Telegram
                        </a>
                       <!-- <a href="https://lorenzoloddo.com" target="_blank" class="footer-link mt-2" style="letter-spacing:3px;opacity: .8;font-size:13px;text-decoration:none;">
                          <i><img src="<?php echo e(asset('asset/img/blog.svg')); ?>" style="pointer-events: none"></i></i>
                            Blog
                        </a>
                        <a href="https://twitter.com/_Freeloot_" target="_blank" class="footer-link mt-2 paraff"  style="letter-spacing:3px;opacity: .8;text-decoration:none;">
                          <i><img src="<?php echo e(asset('asset/img/twitterlogo.svg')); ?>" style="pointer-events: none" ></i></i>
                            Twitter
                        </a>
...
<div class="container" style="user-select:none;">
    ...
    <div class="copy-right d-flex justify-content-between">
        <p></p>
        <p></p>
        <p style="letter-spacing:3px;opacity: .8;font-size: 10px;"><?php echo app('translator')->get('All Rights Reserved'); ?> &copy;2022-<?php echo e(date('Y')); ?> Freeloot</p>
        <p></p>
        <p></p>
    </div>
</div>
...
<?php endif; ?>
<?php /**PATH /home/freebpbk/public_html/core/resources/views/layouts/frontend/partial/foot.blade.php ENDPATH**/ ?>