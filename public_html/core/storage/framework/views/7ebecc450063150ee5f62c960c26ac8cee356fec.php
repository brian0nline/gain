                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('user.change.password')); ?>" method="post" class="register">
                            ...
                            <div class="form-group text-center">
                                <input type="submit" class="mt-4 btn btn-primary" style="box-shadow: none;font-size:14px;" value="<?php echo app('translator')->get('Update'); ?>" >
                            </div>
                        </form>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u972333121/domains/testnetgainify.net/public_html/core/resources/views/user/password.blade.php ENDPATH**/ ?>