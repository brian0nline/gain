        ...
        <div class="dashboard-nav">
            ...
            <nav class="dashboard-nav-list">
                <a href="<?php echo e(url('/')); ?>" id="dashboard_main_image_container">
                    <img src="<?php echo e(asset('asset/img/gainify-logo.png')); ?>" width="90px" id="dashboard_main_image">
                </a>
                <?php if(userInfo()->role): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="dashboard-nav-item"
        ...
        <div class='dashboard-app'>
            <header class='dashboard-toolbar' style="display:flex;justify-content:space-between;align-items:center">
                ...
                <a href="<?php echo e(url('/')); ?>" class="logohomeone">
                    <img src="<?php echo e(asset('asset/img/gainify-logo.png')); ?>" width="120px" class="logo-img"/>
                </a>
                <a href="<?php echo e(url('/')); ?>" class="logohometwo" style="display:none">
                    <img src="<?php echo e(asset('asset/img/mobile_logo.svg')); ?>" style="margin-top:8px;width:50px;">
                </a>

                <div class="top-navbar-link-container">
                    <?php if(auth()->check()): ?>
                        <?php if(userInfo()->role): ?>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="top-navbar-link" style="font-size:14px;"
                                target="_blank">
                                <img src="<?php echo e(asset('asset/img/adminbottom.svg')); ?>" style="pointer-events:none;width:24px">
                                <span class="title" style="font-size:14px;">Admin</span>
                            </a>
                        <?php endif; ?>
                    <?php endif; ?>
                    <a href="<?php echo e(route('user.home')); ?> "
                        class="top-navbar-link <?php echo e(Route::currentRouteName() == 'user.home' ? 'top-bar-active' : ''); ?>">
                        <img src="<?php echo e(asset('asset/img/icons8-money-bag-100.png')); ?>" style="pointer-events:none;width:24px">
                        <span class="title">Earn</span>
                    </a>


                    <a href="<?php echo e(route('user.withdraw')); ?>"
                        class="top-navbar-link <?php echo e(Route::currentRouteName() == 'user.withdraw' ? 'top-bar-active' : ''); ?>">
                        <img src="<?php echo e(asset('asset/img/icons8-withdraw-64_1.png')); ?>" style="pointer-events:none;width:24px">
                        <span class="title">Shop</span>
                    </a>
                    
                    <a href="<?php echo e(route('user.commissions')); ?>"
                class="top-navbar-link <?php echo e(Route::currentRouteName() == 'user.commissions' ? 'top-bar-active' : ''); ?>">
                        <img src="<?php echo e(asset('asset/img/referralsbottom.svg')); ?>" style="pointer-events:none;width:24px">
                  ...
                  <!--  <a href="#"
                        ...
                        <img src="<?php echo e(asset('asset/img/icons8-crown-100.png')); ?>" style="pointer-events:none;width:20px">
               ...
               <!-- <img src="<?php echo e(asset('asset/images/bell.png')); ?>" width="26" alt="">-->
               
                <div class="dash-toolbar-links">
                    <a href="#" class="dash-nav-link">
                        <span><img src="<?php echo e(asset('asset/img/coins.svg')); ?>" style="width: 22px;" ></span>
                ...
                <div class="dash-toolbar-links">
                    <a href="<?php echo e(route('user.profile.setting')); ?>" class="dash-nav-link">
                        <img src="<?php echo e(asset('asset/images/user.png')); ?>" width="20" alt="">
                        <span class="text-success" style="letter-spacing: 1px;">
                            User
                        </span>
                        <img src="<?php echo e(asset('asset/img/arrowuser.svg')); ?>" width="20" alt="">
                    </a>
                </div>
...
<div class="container">
    <div class="row justify-content-center">
        <?php if(request()->routeIs('user.register')): ?>
            ...
            <?php else: ?>
                <div
                    class=" <?php echo e(request()->routeIs('tos') || request()->routeIs('policy') || request()->routeIs('faq') ? 'col-md-12' : 'col-md-6'); ?>">
        <?php endif; ?>
        <div
            class="<?php echo e(request()->routeIs('user.register') || request()->routeIs('user.login') ? 'panel' : ''); ?> c-white sd-oreng mt-5rem login-form">
            ...
            <?php if(!auth()->check()): ?>
                <div
                    class="panel-body <?php echo e(request()->routeIs('tos') || request()->routeIs('policy') || request()->routeIs('faq') ? 'mt-5' : ''); ?>">
                    <?php if (! empty(trim($__env->yieldContent('content')))): ?>
                        <?php echo $__env->yieldContent('content'); ?>
                    <?php endif; ?>
                </div>
        ...
        <div class="top-navbar-link-container">
            ...
            <?php if(auth()->check()): ?>
                <?php if(userInfo()->role): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="top-navbar-link" style="font-size:14px;"
                        target="_blank">
                        <i><img src="<?php echo e(asset('asset/img/adminbottom.svg')); ?>" style="width:24px;"></i>
           ...
           <!-- <a href="<?php echo e(route('user.profile.setting')); ?>"
                class="top-navbar-link <?php echo e(Route::currentRouteName() == 'user.profile.setting' ? 'top-bar-active' : ''); ?>">
...
<?php /**PATH /home/u972333121/domains/testnetgainify.net/public_html/core/resources/views/layouts/theme/default.blade.php ENDPATH**/ ?>