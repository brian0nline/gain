...
} elseif ($_instance->childHasBeenRendered('85ISm4c')) {
    $componentId = $_instance->getRenderedChildComponentId('85ISm4c');
    $componentTag = $_instance->getRenderedChildComponentTagName('85ISm4c');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('85ISm4c');
} else {
    $response = \Livewire\Livewire::mount('loader', []);
    $html = $response->html();
    $_instance->logRenderedChild('85ISm4c', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('DNaMecs')) {
    $componentId = $_instance->getRenderedChildComponentId('DNaMecs');
    $componentTag = $_instance->getRenderedChildComponentTagName('DNaMecs');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DNaMecs');
} else {
    $response = \Livewire\Livewire::mount('modals', []);
    $html = $response->html();
    $_instance->logRenderedChild('DNaMecs', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('XJvGHcW')) {
    $componentId = $_instance->getRenderedChildComponentId('XJvGHcW');
    $componentTag = $_instance->getRenderedChildComponentTagName('XJvGHcW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XJvGHcW');
} else {
    $response = \Livewire\Livewire::mount('toasts', []);
    $html = $response->html();
    $_instance->logRenderedChild('XJvGHcW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/freebpbk/demo.freeloot.net/core/resources/views/admin/layout/primary.blade.php ENDPATH**/ ?>