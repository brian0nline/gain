...
<?php endif; ?>-->
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-block btn-primary mr-2" style="background: #4aa276;border-color: #4aa276;box-shadow:none;" disabled><?php echo app('translator')->get('Submit'); ?></button>
                        <button class="btn btn-warning btn-block" type="submit" wire:click="cancelEdit()" style="background: #3B4740;border-color: #3B4740;box-shadow:none;">Cancel </button>
                    </div>
                </form>
            </div>
        </div>
...
<?php /**PATH /home/freebpbk/demo.freeloot.net/core/resources/views/admin/email/edit.blade.php ENDPATH**/ ?>