...
<?php $__env->startSection('title', __('Shop | Freeloot')); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-12">
        <h2 style="opacity: .8;margin-left:5px" class="hdue"><img src="<?php echo e(asset('asset/img/shop.svg')); ?>">  Shop</h2>
        <p style="opacity: .8;margin-bottom:50px;margin-left: 5px;" class="paraff">Exchange your coins in cash or crypto and receive it within minutes!</p>
    </div>
            ...
            <div class="modal-content bg-dark" style="border-radius: 20px;">
                <form action="<?php echo e(route('user.withdraw.money')); ?>" method="post">
                    ...
                    <div class="modal-footer  justify-content-center border-0">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal"style="box-shadow: none;border-color: #3B4740;background: #3B4740;font-size:14px;"><?php echo app('translator')->get('Cancel'); ?></button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script>
        (function($) {
            ...
            $('.withdraw').on('click', function() {
                ...
                var imagePath = 'https://freeloot.net/asset/images/withdraw/method/'+result.image;
                
                if(result.name=='Paypal'){
                    imagePath = 'https://freeloot.net/asset/images/gateway/paypal.svg';
                }
                else if(result.name=='Bitcoin'){
                     imagePath = 'https://freeloot.net/asset/images/gateway/bitcoin.svg';
                }
                else if(result.name=='Litecoin'){
                    imagePath = 'https://freeloot.net/asset/images/gateway/litecoin.svg';
                }
                else if(result.name == 'Dogecoin'){
                  imagePath = 'https://freeloot.net/asset/images/gateway/dogecoin2.svg';   
                }
...
<?php echo $__env->make('layouts.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/freebpbk/public_html/core/resources/views/user/withdraw/methods.blade.php ENDPATH**/ ?>