                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('moder.users.update', [$user->id])); ?>" method="POST"
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <button type="submit" class="btn btn-success btn-block my-1 w-100" style="box-shadow:none;background: #4aa276;border-color: #4aa276;" disabled><?php echo app('translator')->get('Save Changes'); ?>
                                    </button>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('moder.users.add.sub.balance', $user->id)); ?>" method="POST">
                    ...
                    <div class="modal-footer" style="border-top: 2px solid #242B27;">
                        ...
                        <button type="submit" class="btn btn-success" style="background: #4aa276;border-color: #4aa276;box-shadow:none;" disabled><?php echo app('translator')->get('Submit'); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('admin.layout.primary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u972333121/domains/testnetgainify.net/public_html/core/resources/views/admin/users/detail.blade.php ENDPATH**/ ?>