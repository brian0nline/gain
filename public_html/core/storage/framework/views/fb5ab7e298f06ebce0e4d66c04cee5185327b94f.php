                ...
                <div class="col-xl-6 col-12">
                    <div class="earning-box shadow-sm">
                        <div class="animated flipInY">
                            <div class="tile-stats">
                                <div class="icon" style="font-size:25px;">  
                                    <i><img src="<?php echo e(asset('asset/img/withdrawalsadmin.svg')); ?>"></i> <?php echo e($data['offersEarned']); ?> 
                                </div>
...
<?php /**PATH /home/u972333121/domains/testnetgainify.net/public_html/core/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>