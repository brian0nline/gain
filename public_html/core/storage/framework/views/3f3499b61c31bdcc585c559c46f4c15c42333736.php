...
<?php endif; ?>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-block btn-success mr-2" style="background:#4aa276;border-color: #4aa276;box-shadow:none;"><?php echo app('translator')->get('Update'); ?></button>
                    </div>
                </form>
            </div><!-- card end -->
        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="modal-footer" style="border-top: 1px solid #242B27;box-shadow:none;">
                        ...
                        <button type="submit" class="btn btn-success" style="background:#4aa276;border-color: #4aa276;box-shadow:none;"><?php echo app('translator')->get('Send'); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<?php /**PATH /home/freebpbk/public_html/core/resources/views/admin/email/config.blade.php ENDPATH**/ ?>