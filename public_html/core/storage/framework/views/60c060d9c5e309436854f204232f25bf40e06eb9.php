                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form class="demo-form" data-parsley-validate wire:submit.prevent="save">
                            ...
                            <input type="submit" class="btn btn-success" value="save" style="margin-top:20px;box-shadow:none;background:#4aa276;border-color:#4aa276;" />
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <form class="demo-form" data-parsley-validate wire:submit.prevent="save">
                            ...
                            <input type="submit" class="btn btn-success" value="<?php echo app('translator')->get('save'); ?>"style="margin-top:20px;box-shadow:none;background:#4aa276;border-color:#4aa276;"/>
                        </form>
                    </div>
                </div>
            </div>
...
<?php /**PATH /home/freebpbk/public_html/core/resources/views/admin/setting/security.blade.php ENDPATH**/ ?>