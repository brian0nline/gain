...
<?php endif; ?>
                ...
                <button type="submit" class="btn btn-success btn-block w-100" style="box-shadow:none;background: #4aa276;border-color:#4aa276;border-radius:10px;" disabled><?php echo app('translator')->get('Save'); ?></button>
            </form>
        </div>
    </div>
</div>
<?php /**PATH /home/freebpbk/demo.freeloot.net/core/resources/views/system/admin/setup.blade.php ENDPATH**/ ?>