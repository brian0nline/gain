...
<?php endif; ?>
                ...
                <input type="submit" value="<?php echo app('translator')->get('Save'); ?>" class="btn btn-primary" style="box-shadow:none;border-color:#4aa276;background:#4aa276;" disabled />
            </form>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin.layout.primary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/freebpbk/demo.freeloot.net/core/resources/views/system/admin/offer-wall/index.blade.php ENDPATH**/ ?>