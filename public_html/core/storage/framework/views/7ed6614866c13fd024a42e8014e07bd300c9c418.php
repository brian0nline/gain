        ...
        <div class='dashboard-app'>
            <header class='dashboard-toolbar' style="display:flex;justify-content:space-between;align-items:center">
                ...
                <a href="<?php echo e(url('/')); ?>" class="logohomeone">
                    <img src="<?php echo e(asset('asset/img/gainify-logo.png')); ?>" width="90px" class="logo-img"/>
                </a>
                ...
                <div class="top-navbar-link-container">
                    <?php if(auth()->check()): ?>
                        <?php if(userInfo()->role): ?>
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="top-navbar-link" style="font-size:14px;"
                                target="_blank">
                                <img src="<?php echo e(asset('asset/images/earn.png')); ?>" style="pointer-events:none;width:24px">
                    ...
                    <a href="<?php echo e(route('user.withdraw')); ?>"
                        ...
                        <img src="<?php echo e(asset('asset/images/shop.png')); ?>" style="pointer-events:none;width:24px">
                        <span class="title">Shop</span>
                    </a>

                    <a href="#"
                        class="top-navbar-link">
                        <img src="<?php echo e(asset('asset/images/leaderboard.png')); ?>" style="pointer-events:none;width:20px">
                ...
                <div class="dash-toolbar-links">
                    <a href="<?php echo e(route('user.profile.setting')); ?>" class="dash-nav-link">
                        ...
                        <img src="<?php echo e(asset('asset/images/fly.png')); ?>" width="20" alt="">
                    </a>
                </div>
...
<?php /**PATH E:\laragon\www\gainify\core\resources\views/layouts/theme/default.blade.php ENDPATH**/ ?>