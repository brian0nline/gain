...
unset($__errorArgs, $__bag); ?>" name="value"
        ...
        <button type="submit" class="btn btn-secondary w-100" style="background:#6FB99F;border-color:#6FB99F;box-shadow:none;margin-top:10px;"><?php echo app('translator')->get('Send Password Code'); ?></button>
...
<?php echo $__env->make('layouts.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u972333121/domains/testnetgainify.net/public_html/core/resources/views/user/auth/passwords/email.blade.php ENDPATH**/ ?>