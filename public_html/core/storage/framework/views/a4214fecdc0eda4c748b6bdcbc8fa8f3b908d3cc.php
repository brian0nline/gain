...
<head>
    ...
    <link href="<?php echo e(asset('asset/img/favicon.svg')); ?>" rel="icon">
                        ...
                        <div class="left-part">
                            <div class="navbar-header">
                                <a class="navbar-brand" href="<?php echo e(route('welcome')); ?>">
                                    <span>
                                        <img src="<?php echo e(asset('asset/img/gainifylg.svg')); ?>" width="200" class="dark-logo" alt="logo" style="pointer-events:none;" />
                                </a>
                            </div>
                            ...
                            <ul class="navbar-nav" id="adminTopNavbar">
                                    ...
                                    <li class="nav-item dropdown dropdown-hover medium-hide-link">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item" href="<?php echo e(route('moder.tools')); ?>">Tools</a></li>
...
} elseif ($_instance->childHasBeenRendered('9EYAIcz')) {
    $componentId = $_instance->getRenderedChildComponentId('9EYAIcz');
    $componentTag = $_instance->getRenderedChildComponentTagName('9EYAIcz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9EYAIcz');
} else {
    $response = \Livewire\Livewire::mount('loader', []);
    $html = $response->html();
    $_instance->logRenderedChild('9EYAIcz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('YQJhOiF')) {
    $componentId = $_instance->getRenderedChildComponentId('YQJhOiF');
    $componentTag = $_instance->getRenderedChildComponentTagName('YQJhOiF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YQJhOiF');
} else {
    $response = \Livewire\Livewire::mount('modals', []);
    $html = $response->html();
    $_instance->logRenderedChild('YQJhOiF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    <?php
...
} elseif ($_instance->childHasBeenRendered('5Xww54v')) {
    $componentId = $_instance->getRenderedChildComponentId('5Xww54v');
    $componentTag = $_instance->getRenderedChildComponentTagName('5Xww54v');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5Xww54v');
} else {
    $response = \Livewire\Livewire::mount('toasts', []);
    $html = $response->html();
    $_instance->logRenderedChild('5Xww54v', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /home/u972333121/domains/testnetgainify.net/public_html/core/resources/views/admin/layout/primary.blade.php ENDPATH**/ ?>