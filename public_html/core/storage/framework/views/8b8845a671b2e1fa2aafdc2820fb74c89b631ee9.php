            ...
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('moder.withdraw.method.activate')); ?>" method="POST">
                    ...
                    <div class="modal-footer" style="border-top: 2px solid #242B27;">
                        ...
                        <button type="submit" class="btn btn-primary" style="background:#4aa276;border-color:#4aa276;box-shadow:none;"disabled><?php echo app('translator')->get('Activate'); ?></button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-content" style="border-radius:20px;">
                ...
                <form action="<?php echo e(route('moder.withdraw.method.deactivate')); ?>" method="POST">
                    ...
                    <div class="modal-footer"  style="border-top: 2px solid #242B27;">
                        ...
                        <button type="submit" class="btn btn-danger" style="background:#e84b3c;border-color:#e84b3c;box-shadow:none;" disabled ><?php echo app('translator')->get('Disable'); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('admin.layout.primary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/freebpbk/demo.freeloot.net/core/resources/views/admin/withdraw/index.blade.php ENDPATH**/ ?>