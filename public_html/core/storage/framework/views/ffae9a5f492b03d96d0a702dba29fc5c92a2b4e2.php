<?php $__env->startSection('title', trans('Register | Gainify')); ?>
                 ...
                 <div class="col-12">
                    <div class="form-group">
                        ...
                        <label class="custom-form-label"><?php echo app('translator')->get('Signing up you agree to the '); ?>
                            <a href="<?php echo e(route('tos')); ?>" style="text-decoration:none;color: #6FB99F"><?php echo app('translator')->get('Terms of Service'); ?></a> and 
                            <a href="<?php echo e(route('policy')); ?>" style="text-decoration:none;color: #6FB99F"><?php echo app('translator')->get('Privacy Policy'); ?></a>
                        </label>
                    </div>
                </div>
                
                <div class="d-grid gap-6">
                    <button type="submit" class="btn btn-primary mt-3" style="box-shadow: none;border-radius:10px;font-size:14px" ><?php echo app('translator')->get('Register
                                        Now'); ?></button>
             <div class="col-12 text-center">
                    <p class="text-center mt-3"><span class=""><?php echo app('translator')->get('Have an account?'); ?></span> <a
                            href="<?php echo e(route('user.login')); ?>" class="text-base"style="text-decoration:none;color: #6FB99F"><?php echo app('translator')->get('Login here'); ?></a></p>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer"  style="border-top: 2px solid #242B27;">
                    ...
                    <a href="<?php echo e(route('user.login')); ?>" class="btn btn-primary" style="background: #6FB99F;border-color:#6FB99F;box-shadow:none;"><?php echo app('translator')->get('Login'); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.theme.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u972333121/domains/testnetgainify.net/public_html/core/resources/views/user/auth/register.blade.php ENDPATH**/ ?>