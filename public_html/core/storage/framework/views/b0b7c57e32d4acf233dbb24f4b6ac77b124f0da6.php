...
<?php endif; ?>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-success btn-block" style="background:#4aa276;border-color:#4aa276;box-shadow:none;"disabled ><?php echo app('translator')->get('Save Method'); ?></button>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make('admin.layout.primary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u972333121/domains/testnetgainify.net/public_html/core/resources/views/admin/withdraw/create.blade.php ENDPATH**/ ?>