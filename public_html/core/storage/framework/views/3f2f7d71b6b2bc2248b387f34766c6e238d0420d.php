                ...
                <div class="card">
                    ...
                    <div class="card-body" wire:ignore>
                        ...
                        <form id="demo-form" action="<?php echo e(route('moder.update.setting.control')); ?>" method="POST">
                            ...
                            <input type="submit" class="btn btn-success" value="<?php echo app('translator')->get('Save'); ?>" style="margin-top:20px;box-shadow:none;" />
                        </form>
                    </div>
                </div>
            </div>
...
<?php /**PATH /home/freebpbk/public_html/core/resources/views/admin/setting/setup.blade.php ENDPATH**/ ?>