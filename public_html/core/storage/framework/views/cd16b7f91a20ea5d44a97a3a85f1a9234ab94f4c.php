            ...
            <div class="card mt-2">
                ...
                <div class="card-body parent">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6">
                            <button type="button" class="btn btn-sm btn-success generate" style="box-shadow:none;" disabled>
            ...
            <div class="card mt-2">
                ...
                <div class="card-body parent">
                        ...
                        <div class="col-md-12">
                            <?php if($general->wc == 0): ?>
                                <a href="<?php echo e(route('moder.referral.status', 'wc')); ?>"
                                    class="btn btn-primary" style="background:#4aa276;border-color:#4aa276;box-shadow:none;" disabled><?php echo app('translator')->get('Enable Now'); ?></a>
                            <?php else: ?>
                                <a href="<?php echo e(route('moder.referral.status', 'wc')); ?>"
                                    class="btn btn-danger btn-sm mb-3" style="background:#e84b3c;border-color:#e84b3c;box-shadow:none;" disabled><?php echo app('translator')->get('Disable Now'); ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3 mb-5">
                        ...
                        <div class="col-md-6">
                            <button type="button" class="btn btn-success btn-sm generate" style="box-shadow:none;" disabled>
                                <?php echo app('translator')->get('GENERATE'); ?>
                            </button>
                        </div>
                    </div>
                    ...
                    <form action="<?php echo e(route('moder.store.refer')); ?>" method="post">
                        ...
                        <div class="d-none levelForm">
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-primary btn-block my-3" disabled><?php echo app('translator')->get('Submit'); ?></button>
                            </div>
                        </div>
                    </form>
...
<?php echo $__env->make('admin.layout.primary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/freebpbk/demo.freeloot.net/core/resources/views/admin/referral/index.blade.php ENDPATH**/ ?>