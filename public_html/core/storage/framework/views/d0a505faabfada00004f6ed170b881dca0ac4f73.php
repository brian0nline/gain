                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <button class="btn btn-success ml-1 approveBtn" data-toggle="tooltip"
                                    ...
                                    data-amount="<?php echo e(showAmount($withdrawal->final_amount)); ?> <?php echo e($withdrawal->currency); ?>" style="box-shadow:none;" >
                                ...
                                <button class="btn btn-danger ml-1 rejectBtn" data-toggle="tooltip"
                                    ...
                                    data-amount="<?php echo e(showAmount($withdrawal->final_amount)); ?> <?php echo e(__($withdrawal->currency)); ?>" style="box-shadow:none;background:#e84b3c;border-color:#e84b3c;" >
...
<?php echo $__env->make('admin.layout.primary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u972333121/domains/testnetgainify.net/public_html/core/resources/views/admin/withdraw/detail.blade.php ENDPATH**/ ?>