<?php $__env->startSection('title', 'Referral System | Gainify'); ?>
                ...
                <div class="card-body parent">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php if($general->dc == 0): ?>
                                <a href="#"
                                    class="btn btn-info btn-sm mb-3" style="background:#6FB99F;border-color:#6FB99F;box-shadow:none;" ><?php echo app('translator')->get('Enable Now'); ?></a>
                            <?php else: ?>
                                <a href="#"
                        ...
                        <div class="col-md-12">
                            <?php if($general->wc == 0): ?>
                                <a href="<?php echo e(route('moder.referral.status', 'wc')); ?>"
                                    class="btn btn-primary" style="background:#6FB99F;border-color:#6FB99F;box-shadow:none;" ><?php echo app('translator')->get('Enable Now'); ?></a>
                            <?php else: ?>
                                <a href="<?php echo e(route('moder.referral.status', 'wc')); ?>"
                                    class="btn btn-danger btn-sm mb-3" style="background:#e84b3c;border-color:#e84b3c;box-shadow:none;" ><?php echo app('translator')->get('Disable Now'); ?></a>
                            <?php endif; ?>
...
<?php echo $__env->make('admin.layout.primary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u972333121/domains/testnetgainify.net/public_html/core/resources/views/admin/referral/index.blade.php ENDPATH**/ ?>