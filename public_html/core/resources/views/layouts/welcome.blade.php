                ...
                <div class="feature-boxes">
                    <div class="feature-boxes">
                        <div class="feature-box">
                            ...
                            <p style="font-size:20px;">{{ \App\Models\User::count() }}</p>
                        </div>
                        <div class="feature-box">
                            <p style="font-size:18px;font-weight:700;">Offers Completed</p>
                            <p style="font-size:20px;">{{ \App\Models\System\OfferLog::where('isPaid', true)->count() }}
                            </p>
                        </div>
                        <div class="feature-box">
                            <p style="font-size:18px;font-weight:700;">USD Earned</p>
                            <p style="font-size:20px;">$
                                {{ \App\Models\System\OfferLog::where('isPaid', true)->sum('amount') }}
                            </p>
                        </div>
                    </div>
                </div>
