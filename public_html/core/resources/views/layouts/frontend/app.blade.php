...
<body>
    ...
    <div id="sound_notify" class="fixed-bottom d-none">
        <div class="alert alert-dark sound_alert alert-dismissible fade show p-0" role="alert">
            <audio controls class="sound_player"  autoplay="true">
              <!--<source src="{{ asset('asset/static/sound/cash.mp3') }}" type="audio/mpeg">-->
    ...
    @if(!session()->has('cookie_concent'))
    <div class="cookie-consent-banner" id="cookie-banner">
    <div class="cookie-consent-banner__inner">
        <div class="cookie-consent-banner__copy">
            <div class="cookie-consent-banner__header"> <img src="{{asset('asset/images/cookie.png')}}" style="width: 20px;" alt=""> We use cookies!</div>
...
<script>
    $(document).ready(function(){
        ...
        //    $.ajax({
        //       type:"GET",
        //       url:"{{route('user.offer.check-user-notify')}}",
       ...
       // },5000);
        ...
        $('#remove_sound').click(function(e){
            ...
            $.ajax({
                type:"GET",
                url:"{{route('user.offer.update-user-notify')}}",
                data:{disable:true},
                success:function(res){
                    if(res.data === true){
