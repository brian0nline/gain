                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="widget">
                            ...
                            <div class="links-group">
                                <a href="{{ route('tos') }}" class="footer-link mt-2" style="text-decoration: none;">
                    ...
                    <div class="col-md-6">
                        <div class="widget">
                            ...
                            <div class="links-group">
                                <a href="/help-center" class="footer-link mt-2" style="text-decoration: none;">
                                    Help Center
                                </a>
...
<div class="container" style="user-select:none;">
    <div class="d-flex justify-content-center">
        <p style="font-size: 16px;color: #fff;font-weight: 400;letter-spacing: 1px;">
            @lang('All Rights Reserved.') &copy;Copyright {{ date('Y') }}</p>
    </div>
</div>

<script src="{{ asset('asset/vendor/nicescroll') }}/jquery.nicescroll.min.js"></script>
...
@endif
<script src="{{ asset('asset/vendor/toastr/build/toastr.min.js') }}"></script>
