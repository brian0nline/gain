...
@else
                        ...
                        @endif
                            "
                           class="btn btn-primary w-100 btn-block mb-3 text-center @if (request()->url() == route('user.referred', $i, auth()->user()->id) || ($firstActive == 1 && $i == 1)) btn-disabled @endif">@lang('Level
                            '.$i)</a>
                    </div>
                @endfor
                <div class="col-md-12">
