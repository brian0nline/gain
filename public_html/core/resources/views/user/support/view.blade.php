            ...
            <div class="col-md-12">
                <div class="card card">
                    <div class="card-header card-header-bg d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <button class="btn btn-danger btn-sm close-button" type="button" title="@lang('Close Ticket')"
                                ...
                                <div class="card-body">
                                    @if ($my_ticket->status != 3)
                                            ...
                                            <div class="row justify-content-between">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <textarea name="message" class="form-control form-control-lg" id="inputMessage" placeholder="@lang('Your Reply')" rows="4"
                                        ...
                                        <h3>@lang('Your Ticket closed,')  
                                            <br />
                                            @lang('You Can')  <a href="{{ route('ticket.open') }}">@lang('Open new')</a>
                                        </h3>
                                    @endif
                                </div>
                            </div>
