        ...
        <div class="col-lg-12">
            <div class="card b-radius-10 ">
                <div class="card-body p-0">
                    <a href="{{ route('moder.users.detail', $user->id) }}" class="btn btn-info" style="box-shadow:none;background:#4aa276;border-color:#4aa276;border-top-right-radius:0px;border-top-left-radius:10px;border-bottom-left-radius:0px"><i
                                ...
                                @forelse($logs as $log)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <a href="{{ route('moder.users.email.details', $log->id) }}"
                                               <i><img src="{{ asset('asset/img/desktop.svg') }}"></i></a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
