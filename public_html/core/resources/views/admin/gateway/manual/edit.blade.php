...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('moder.gateway.manual.update', $method->code) }}" method="POST"
                                        ...
                                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4 mb-15">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="@lang('Method Name')"
                                                    name="name" required value="{{ $method->name }}" />
                                            </div>
                                        </div>
                                        <div class="col-xl-3 col-md-6">
                                            <div>
                                                ...
                                                <input type="text" name="currency" placeholder="@lang('Currency')"
                                                    class="form-control border-radius-5" required
                                        ...
                                        <div class="col-xl-5 col-md-12">
                                            ...
                                            <div class="input-group has_append">
                                                ...
                                                <input type="text" class="form-control" placeholder="0" name="rate"
                                                    required value="{{ getAmount(@$method->single_currency->rate) }}" />
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <textarea rows="8" class="form-control border-radius-5 nicEdit"
                                                        name="instruction"
                                                        id="content">{{ __(@$method->description) }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                                    ...
                                                                    <div class="input-group mb-md-0 mb-4">
                                                                        ...
                                                                        <div class="col-md-3 mt-md-0 mt-2">
                                                                            <select name="type[]" class="form-control">
                                                                                ...
                                                                                <option required value="textarea"
                                                                                    @if ($v->type == 'textarea') selected @endif>
                                                                                    @lang('Textarea') </option>
                                                                                <option required value="file"
                                                                        ...
                                                                        <div class="col-md-3 mt-md-0 mt-2">
                                                                            <select name="validation[]"
                                                                                ...
                                                                                <option required value="nullable"
