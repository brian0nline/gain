...
class ManageUsersController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        return view('admin.users.detail', compact('pageTitle', 'user', 'userAddress', 'totalDeposit', 'totalWithdraw', 'totalTransaction', 'countries', 'reff'));
    }
    ...
    public function deposits(Request $request, $id)
    {
        ...
        if ($request->search) {
            ...
            return view('admin.deposit.log', compact('pageTitle', 'search', 'user', 'filter', 'deposits', 'emptyMessage', 'userId'));
        }
        ...
        $emptyMessage = 'No deposits';
        $scope = 'all';
        return view('admin.deposit.log', compact('pageTitle', 'user', 'filter', 'deposits', 'emptyMessage', 'userId', 'scope', 'successful', 'pending', 'rejected'));
    }
