...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'checkStatus2' => CheckStatus2::class,
        'checkStatusApi' => CheckStatusApi::class,
        'permission' => PermissionAccessMiddleware::class,
        'isUserActive' => UserStatusMiddleware::class,
        'isDemo' => IsDemo::class,
        'adminTwoFactor' => AdminTwoFactor::class,
