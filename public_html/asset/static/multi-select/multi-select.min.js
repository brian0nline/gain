(function(d) {
    ...
    d.extend(g.prototype, {
        ...
        C: function() { if (!1 === this.b.is("select[multiple]")) throw Error("$.multiSelect only works on <select multiple> elements"); },
        L: function() { this.l = d('label[for="' + this.b.attr("id") + '"]') },
        F: function() {
        ...
        D: function() {
            ...
            this.g.attr({ role: "button", "aria-haspopup": "true", tabindex: 0, "aria-label": this.l.eq(0).text() }).on("keydown.multiselect", function(b) {
                var c = b.which;
                13 === c || 32 === c ? (b.preventDefault(), a.g.click()) : 40 === c ? (b.preventDefault(), a.s(), (a.i || a.h).children().first().focus()) : 27 === c && a.j()
            }).on("click.multiselect", function() { a.u() }).appendTo(this.f);
            this.b.on("change.multiselect", function() { a.w() });
            this.w()
        },
        w: function() {
            var a = [],
        ...
        H: function() {
            ...
            this.b.on("change.multiselect", function(b, c) {!0 !== c && a.A() });
            this.A()
        },
        A: function() {
            var a = this;
            this.h.empty();
            this.b.children("optgroup,option").each(function(b, c) { "OPTION" === c.nodeName ? (b = a.o(d(c), b), a.h.append(b)) : a.I(d(c), b) })
        },
        v: function(a, b) {
            var c = b.which;
        ...
        K: function() {
            ...
            d.each(this.a.presets, function(b, c) {
                ...
                var f = d(a.a.menuItemHTML).attr({ "for": b, role: "menuitem" }).text(" " + c.name).on("keydown.multiselect", a.v.bind(a, "preset")).appendTo(a.i);
                b = d("<input>").attr({ type: "radio", name: a.b.attr("name") + "_presets", id: b }).prependTo(f);
            ...
            this.b.on("change.multiselect", function() { a.B() });
            this.B()
        },
        B: function() {
            var a = this;
        ...
        o: function(a, b) {
            ...
            b = d(this.a.menuItemHTML).attr({ "for": c, role: "menuitem" }).on("keydown.multiselect", this.v.bind(this, "menuitem")).text(" " + a.text());
        ...
        J: function() {
            var a = this;
            this.a.modalHTML && (this.m = d(this.a.modalHTML), this.m.on("click.multiselect", function() { a.j() }), this.m.insertBefore(this.c))
        },
        N: function() {
            var a = this;
            d("html").on("click.multiselect", function() { a.j() });
            this.f.on("click.multiselect", function(b) { b.stopPropagation() })
        },
        O: function() {
            var a = this;
        ...
        s: function() {
            ...
            a > b - this.a.viewportBottomGutter ?
                this.c.css({ maxHeight: Math.max(b - this.a.viewportBottomGutter - this.c.offset().top, this.a.menuMinHeight), overflow: "scroll" }) : this.c.css({ maxHeight: "", overflow: "" })
        },
        j: function() {
        ...
        u: function() { this.f.hasClass(this.a.activeClass) ? this.j() : this.s() }
    });
