    ...
    f.prototype.modules.nonblock = {
        init: function(c, b) {
            ...
            c.elem.on({
                ...
                mouseleave: function(a) { d.options.nonblock && a.stopPropagation();
                    g = null;
                ...
                mousemove: function(a) { d.options.nonblock && (a.stopPropagation(), e(c, a, "onmousemove")) },
                mousedown: function(a) { d.options.nonblock && (a.stopPropagation(), a.preventDefault(), e(c, a, "onmousedown")) },
                mouseup: function(a) { d.options.nonblock && (a.stopPropagation(), a.preventDefault(), e(c, a, "onmouseup")) },
                click: function(a) { d.options.nonblock && (a.stopPropagation(), e(c, a, "onclick")) },
                dblclick: function(a) {
